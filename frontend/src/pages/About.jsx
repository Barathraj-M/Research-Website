...
import aboutimage from '../assets/Images/2.webp'; // Update with the correct path to your image
...
const About = () => {
            ...
            items: [
                ...
                },
                {
                    ...
                    details: [
                        ...
                        'Position SLSRF as a bridge between empirical science and experiential intelligence'
                    ]
                }
            ]
        },
    ...
    const enablingPillars = [
        ...
        },
        {
            ...
            description: 'Represent SLSRF in biodiversity, health, and climate policy forums.'
        }
    ];
                        ...
                        <div className='md:grid lg:grid-cols-3 md:grid-cols-2  xl:h-[400px] lg:h-[400px] md:h-[360px] border-2 mt-16 sm:mt-20 md:mt-24 lg:mt-24 mb-5'>
                            <div className='relative flex flex-col justify-center gap-3 lg:gap-4'>
                                ...
                                <p className='text-white! leading-relaxed overflow-hidden'>
                                    SLSRF acts as a national and global platform for researchers, innovators, youth leaders , and
