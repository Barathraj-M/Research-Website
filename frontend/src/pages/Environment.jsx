        ...
        <div className="grid sm:auto-rows-auto md:grid-rows-none md:grid-cols-5 gap-y-5 gap-x-5 w-full">
          ...
          <div className="md:col-span-3">
            ...
            >
              ...
              At SLSRF, we conduct clinical and field research on AYUSH-based ecological protocols, positioning them as integral components of preventive healthcare, forest biodiversity, and eco-conscious living.
            </motion.p>
            <motion.p
