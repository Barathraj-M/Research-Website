      ...
      >
        ...
        >
          ...
          <section
            ...
            aria-label="Introduction about SLSRF"
          >
            <SectionPill sectionTitle={"SLSRF"} />
            <div className="flex items-center gap-3">
              <h2 id="welcome-heading" className="mt-2! text-3xl font-bold">
                Welcome to <span className="text-primary-1">SLSRF</span>
              </h2>
            </div>
            <h3
            ...
            >
              Semporutkalai Life Science Research Foundation (SLSRF)
            </h3>
            <p>
            ...
            <p>
              ...
              social entrepreneur and thought leader, SLSRF represents a powerful
              confluence of Eastern ancient wisdom systems and contemporary
              scientific research.
            </p>
            <p>
              Established as a multi-sectoral platform, SLSRF operates as a
          ...
          <motion.div
            ...
            role="img"
            aria-label="Portrait of Thiru. Jeyachandran Srinivasan, founder of SLSRF"
          >
            <img
              src={jc}
        ...
        >
          ...
          >
            ...
            <p className="text-[17px] lg:pe-20 lg:ps-20 pe-5 ps-5">
              ...
              SLSRF addresses this through a Wholistic model of transformation
      ...
      <div className="w-full px-4 py-8">
        ...
        >
          ...
          <motion.div
            ...
            className="flex justify-center"
            role="img"
            aria-label="SLSRF conceptual illustration"
          >
            <img
              src={ancient}
              loading="lazy"
              alt="Illustration representing SLSRF scientific focus"
              className="w-3/4"
            />
          </motion.div>
              ...
              >
                <p className="flex items-start gap-2">
                  <img
                    ...
                    loading="lazy"
                  />
                  SLSRF stands at the frontier where Applied noetic science
