    ...
    return (
        <>
                ...
                <AnimatePresence mode='sync'>
                    <div className='w-full h-full relative'>
                        ...
                        <img
                            ...
                            alt='Contact hero section featuring SLSRF office building with modern architecture and green landscaping'
                        ...
                        <div className='absolute w-full flex flex-col justify-center items-center gap-y-2 md:gap-y-15 bottom-0 left-0 right-0'>
                            <div className='flex flex-col justify-center items-center gap-y-7 max-w-lg'>
                                ...
                                <motion.p
                                    ...
                                    custom={3}
                                >
                                    Innovations for life sciences begin with conscious collaboration. Whether you're advancing noetic research, incubating green technologies, or seeking wholistic environmental solutions, SLSRF is ready to empower your journey.
                                </motion.p>
                            </div>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <a
                                            ...
                                            aria-label="Call SLSRF at +1234567890"
                                        >
                                            +1234567890
                                        </a>
                                    </motion.div>
                                    ...
                                    >
                                        <h5>Write to us</h5>
                                        <a
                                            href='mailto:info@slsrf.com'
                                            className='text-gray-3 hover:text-gray-2'
                                            aria-label="Send email to SLSRF"
                                        >
                                            info@slsrf.com
                                        </a>
                                    </motion.div>
                    ...
                    <div className='w-full flex flex-col justify-center items-center gap-y-10 my-10'>
                        ...
                        >
                            <div id="form-description" className="sr-only">
                                Use this form to send a message to SLSRF. All fields are required.
                            </div>
                            ...
                            />
                            <div id="submit-help" className="sr-only">Click to send your message to SLSRF</div>
                        </motion.form>
                    </div>
                </AnimatePresence>
            </section>
            ...
            >
                ...
                <CollapsableCard
                    heading={'Who founded SLSRF and what is its core philosophy?'}
                    text={'SLSRF was founded by Thiru. Jeyachandran Srinivasan, a distinguished social entrepreneur and thought leader. Its philosophy emphasizes a wholistic model of transformation that integrates science with spirit, technology with ethics, and intangible human consciousness with tangible global development goals.'}
                />
                <CollapsableCard
                    heading={'What is the Noetic Science Enablement on Unified Wholeness (nseUW) program?'}
                    text={'nseUW is a non-commercial, merit-based certification ecosystem offered by SLSRF. It provides a three-year progression-based certification in noetic science, focusing on consciousness practices rooted in Eastern wisdom. It includes capacity building through institutional scopes of work and certifies subject matter experts based on merit.'}
                />
                <CollapsableCard
                    heading={'How does SLSRF integrate ancient knowledge with modern science?'}
                    text={'SLSRF validates and positions ancient systems like Tamil Siddha science, Eastern traditional medicine, and indigenous healing through rigorous scientific research. It bridges East-West integration via mixed-method studies, symposia, and publications that compare ancient practices with Western models.'}
                />
                <CollapsableCard
                    heading={'What are SLSRF\'s funding sources?'}
                    text={'SLSRF uses diversified streams such as government grants from ministries like AYUSH and CSIR, angel and venture capital, NRI investments, corporate CSR projects, project-based revenue, IP commercialization, and merit-based certifications. Revenue is allocated with 80% toward core programs and 20% for operations, with full reinvestment for national development.'}
                />
                <CollapsableCard
                    heading={'How can individuals or organizations collaborate with SLSRF?'}
                    text={'SLSRF partners with ministries, universities, CSR wings, and international agencies for co-creation, policy insights, and empowerment programs. Opportunities include research collaborations, youth cohorts, startup incubation, and participation in noetic certification. Contact SLSRF for merit-based involvement in programs like nseUW or environmental initiatives.'}
                />
            </section>
