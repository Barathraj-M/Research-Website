...
const About = () => {
  ...
  const enablingPillars = [
    {
      title: "SLSRF’s Enduring Contribution",
      icon: (
        <svg
          className="w-5 h-5"
          fill="none"
      ...
      description:
        "One of the most resilient contributions of SLSRF to the social domain is the creation of the Noetic Science Enablement on Unified Wholeness (nseUW)",
    },
    {
              ...
              <ul className="space-y-4 text-[1rem] leading-relaxed" role="list">
                <li className="flex items-start gap-2">
                  <img
                    ...
                    loading="lazy"
                  />
                  SLSRF is committed to evidence-based research focused on
              ...
              <ul className="space-y-4 text-[1rem] leading-relaxed" role="list">
                <li className="flex items-start gap-2">
                  <img
                    ...
                    loading="lazy"
                  />
                  SLSRF uses physiological and psychological assessments to
              ...
              >
                ...
                <p className="flex items-start gap-2">
                  <img
                    ...
                    loading="lazy"
                  />
                  SLSRF understands that meaningful social change must begin
      ...
      >
        ...
        >
          ...
          <motion.div
            ...
            className="flex justify-center w-2/4"
            role="img"
            aria-label="Illustration representing Semporutkalai Life Science Research Foundation"
          >
            <img
              src={science}
            ...
            <div className="flex flex-col md:justify-center gap-0 mx-auto">
              ...
              >
                <p className="flex items-start gap-2">
                  ...
                  />
                  <span>
                    SLSRF also plays a critical role in bridging Eastern and
              ...
              >
                ...
                <p className="flex items-start gap-2">
                  ...
                  />
                  <span>
                    As a result, SLSRF becomes a hub for a new type of
