...
const InnovationSection = () => {
  return (
    <div
      ...
      className='w-full min-h-screen flex flex-col justify-center items-center gap-y-10 xs:px-2 sm:px-5 md:px-10 lg:px-15 xs:pt-2 xs:pb-4 md:py-5 bg-primary-variant-7'
      role="region"
      aria-labelledby="innovation-heading"
    >
      <h2 id="innovation-heading" className="sr-only">Innovation Section</h2>
      ...
      <div className='text-center max-w-2xl flex flex-col gap-y-5'>
        ...
        <motion.p
          ...
          exit='exit'
        >
          SLSRF approaches environmental challenges with a research-to-impact framework. Our focus is on creating deep-tech and ecological tools that can counter biodiversity loss, climate instability, and unsustainable development.
        </motion.p>
      </div>

      <div
        className='w-full flex flex-row flex-wrap justify-center items-center gap-y-0 xs:gap-y-5 md:gap-y-6 xs:gap-x-5 md:gap-x-8 px-4 md:px-0'
        role="list"
        aria-label="Innovation highlights list"
      >
        <motion.div
          ...
          custom={10}
          role="listitem"
          aria-labelledby="phytoVaultTitle"
        >
          <div className='w-16 h-16 mx-auto bg-primary-variant-8 rounded-full flex items-center justify-center md:-mb-5 group-hover:text-primary-1 transition-colors duration-500 ease-in-out' aria-hidden="true">
            <BlockChainIcon width={30} height={30} />
          </div>
          <h4 id="phytoVaultTitle" className='mb-4'>PhytoVault</h4>
        ...
        <motion.div
          ...
          custom={15}
          role="listitem"
          aria-labelledby="aiMappingTitle"
        >
          <div className='w-16 h-16 mx-auto bg-primary-variant-8 rounded-full flex items-center justify-center md:-mb-5 group-hover:text-primary-1 transition-colors duration-500 ease-in-out' aria-hidden="true">
            <TargetIcon width={30} height={30} />
          </div>
          <h4 id="aiMappingTitle" className='mb-4'>AI-Powered Mapping</h4>
          <p className='text-sm text-gray-3 leading-relaxed'>
        ...
        <motion.div
          ...
          custom={20}
          role="listitem"
          aria-labelledby="droneMonitoringTitle"
        >
          <div className='w-16 h-16 mx-auto bg-primary-variant-8 rounded-full flex items-center justify-center md:-mb-5 group-hover:text-primary-1 transition-colors duration-500 ease-in-out' aria-hidden="true">
            <DroneIcon width={30} height={30} />
          </div>
          <h4 id="droneMonitoringTitle" className='mb-4'>Drone Monitoring</h4>
          <p className='text-sm text-gray-3 leading-relaxed'>
