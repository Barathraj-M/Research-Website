            ...
            <div className='w-full -mt-6'>
                <div className='text-center max-w-4xl flex flex-col gap-y-5 mx-auto'>
                    ...
                    <motion.p
                        ...
                        custom={3}
                    >
                        Our definition of engineering goes beyond infrastructure - it includes soil, water, atmosphere, and biodiversity. SLSRF pioneers regenerative environmental engineering that aims not just to reduce harm, but to reverse degradation.
                    </motion.p>
                </div>
