            ...
            <div className='grid xs:auto-rows-auto md:grid-cols-2 gap-x-5 gap-y-5'>
                <div className='p-2 flex flex-col justify-start items-start gap-y-2 xs:ps-2 sm:ps-5 md:ps-10 lg:ps-15 pt-20'>
                    ...
                    <motion.p
                        ...
                        viewport={{ once: true, amount: "some" }}
                    >
                        The environmental initiatives at SLSRF are built to endure. Our measurement systems track not just outputs, but long-term ecological impact - ensuring that everything we touch leaves the planet stronger.
                    </motion.p>
                    <motion.p
                        variants={contentBasicVariants}
                        initial="initial"
