    ...
    <div className="why-choose-us pl-15 pr-15 p-10 mt-12">
      ...
      >
        ...
        >
          ...
          >
            <span className="text-primary-1"> At SLSRF</span>, we believe that
            the future of humanity depends on our ability to evolve — internally
            and externally. Our research Foundation is built upon a dual-core mission
