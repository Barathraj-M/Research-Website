...
const ServiceCard = ({ cardHeading, description, link, img, imgAlt, tagLines }) => {
  return (
    <motion.div 
        className=' xs:p-3 md:p-5 flex flex-col  items-center gap-y-5 cursor-pointer rounded-xl group '
    ...
    >
        <div className='flex gap-x-3 p-1 w-full items-center justify-between'>
